  ...
  provider && (
    <div className={`w3-row ${styles}`}>
      <div className={`w3-col w-16 h-16 rounded-circle useBorder border-0-05 overflow-hidden ${imgStyles}`}>
        <Image imageUrl={avatarUrl || provider.imageUrl} backupImg={no_img_provider} {...imgProps} />
      </div>
      <div className={`w3-col ml-8px w-fit ${provideStyles}`}>
        ...
        <div className={`mt-2 text-sm font-bold text-main uppercase truncate ${nameStyles}`} title={fullName || provider.name}>
